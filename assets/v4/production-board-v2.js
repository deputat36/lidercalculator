...
function ensureStyles() {
  if (document.getElementById('productionBoardV2Styles')) return;
  const style = document.createElement('style');
  style.id = 'productionBoardV2Styles';
  style.textContent = `
...
if (!window.LeaderV4ProductionBoardV2Booted) {
  window.LeaderV4ProductionBoardV2Booted = true;
  boot();
}
