function bootSiteCacheNote() {
  ...
  const key = 'leader-cache-note-seen-20260716';
  ...
  import('./calculations-revision-v1.js?v=20260716-1').catch((error) => {
    console.error('Calculation revision module failed to load:', error);
  });
}
