(function(){
  ...
  function firstMainItem(t){ var arr=Array.isArray(t&&t.items)?t.items:[]; return arr.find(function(x){return x.role==='main'})||arr[0]||null; }
  ...
  function findCatalog(item){ var list=catalog.map(function(c){return {c:c,score:scoreCatalog(c,item)}}).filter(function(x){return x.score>0}).sort(function(a,b){return b.score-a.score}); return list[0]?list[0].c:null; }
